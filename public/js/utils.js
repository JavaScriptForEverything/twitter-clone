...
$('div').addEventListener('click', (evt) => {
	...
	Alert({
		severity: 'error',
		variant: 'filled',
		// snackbar: 'top-1 right-1'
		// title: 'Error'
		message: 'notification update failed',
		action: true,
		autoClose: true,
		closeTime: 2000, 			// autoClose must be true for that
	})
...
const Alert = (props={}) => {
	...
	const snackbarWrapper = `
		<div class="max-w-sm shadow-2xl z-50 absolute ${snackbar} ">
			${htmlString}
		</div>
	`

	htmlString = snackbar ? snackbarWrapper : htmlString
